---
description: "Start/stop the background watcher daemon that fires desktop notifications for new beam messages. Uses zero tokens — pure polling daemon, not a model loop."
